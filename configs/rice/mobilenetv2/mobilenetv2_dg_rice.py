_base_ = [
    ...
    '../../_base_/datasets/dg_rice_448x448.py',
...
input_size = 224
src_data_root = '/extra_disk/Benchmarks/Rice_Src'
trg_data_root = '/extra_disk/Benchmarks/Rice_Trg'
metainfo = {
    'classes': ['Blast', 'BrownSpot', 'Healthy'],
}
